        ...
        <?php
            ...
            foreach ($razdelu as $key => $value):
                ...
                if($key == $sortirovka[0] && $sortirovka[1] == ""){
                    echo "<b><a href='?sort=".$key."'>(по возраст.)</a></b><br><a href='?sort=-".$key."'>(по убыв.)</a>";
                }
                elseif($key == $sortirovka[0] && $sortirovka[1] == "-"){
                    echo "<a href='?sort=".$key."'>(по возраст.)</a><br><b><a href='?sort=-".$key."'>(по убыв.)</a></b>";
                }
                else{
                    echo "<a href='?sort=".$key."'>(по возраст.)</a><br><a href='?sort=-".$key."'>(по убыв.)</a>";
                }
                echo "</td>";
            endforeach;
